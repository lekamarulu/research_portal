...
(APP = new APP).UI = {scrollTop: 0}, $(window).on("load", function () {
    setTimeout(function () {
    ...
    !function () {
        ...
        rules: {timeout_count: {required: !0, digits: !0}},
        ...
        $(e).length && $(e).printMe({path: ["assets/vendors/bootstrap/dist/css/bootstrap.min.css", "assets/css/main.css"]})
    })
